...
**Desarrollo local**: Conexión directa a servicios locales
```bash
NODE_ENV=development
USER_SERVICE=http://localhost:8080
CATALOG_SERVICE=http://localhost:30003
```

**Producción**: Conexión a través del API Gateway
```bash
NODE_ENV=production
NEXT_PUBLIC_API_URL=https://api.melody.com
```
